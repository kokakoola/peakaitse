...
y("date","D"),L("D",Sc),L("DD",Sc,Oc),L("Do",function(a,b){return a?b._ordinalParse:b._ordinalParseLenient}),O(["D","DD"],dd),O("Do",function(a,b){b[dd]=p(a.match(Sc)[0],10)});var zd=B("Date",!0);G("d",0,"do","day"),G("dd",0,0,function(a){return this.localeData().weekdaysMin(this,a)}),G("ddd",0,0,function(a){return this.localeData().weekdaysShort(this,a)}),G("dddd",0,0,function(a){return this.localeData().weekdays(this,a)}),G("e",0,0,"weekday"),G("E",0,0,"isoWeekday"),y("day","d"),y("weekday","e"),y("isoWeekday","E"),L("d",Sc),L("e",Sc),L("E",Sc),L("dd",$c),L("ddd",$c),L("dddd",$c),P(["dd","ddd","dddd"],function(a,b,c){var d=c._locale.weekdaysParse(a);null!=d?b.d=d:j(c).invalidWeekday=a}),P(["d","e","E"],function(a,b,c,d){b[d]=p(a)});var Ad="Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),Bd="Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),Cd="Su_Mo_Tu_We_Th_Fr_Sa".split("_");G("H",["HH",2],0,"hour"),G("h",["hh",2],0,function(){return this.hours()%12||12}),Pb("a",!0),Pb("A",!1),y("hour","h"),L("a",Qb),L("A",Qb),L("H",Sc),L("h",Sc),L("HH",Sc,Oc),L("hh",Sc,Oc),O(["H","HH"],ed),O(["a","A"],function(a,b,c){c._isPm=c._locale.isPM(a),c._meridiem=a}),O(["h","hh"],function(a,b,c){b[ed]=p(a),j(c).bigHour=!0});var Dd=/[ap]\.?m?\.?/i,Ed=B("Hours",!0);G("m",["mm",2],0,"minute"),y("minute","m"),L("m",Sc),L("mm",Sc,Oc),O(["m","mm"],fd);var Fd=B("Minutes",!1);G("s",["ss",2],0,"second"),y("second","s"),L("s",Sc),L("ss",Sc,Oc),O(["s","ss"],gd);var Gd=B("Seconds",!1);G("S",0,0,function(){return~~(this.millisecond()/100)}),G(0,["SS",2],0,function(){return~~(this.millisecond()/10)}),Tb("SSS"),Tb("SSSS"),y("millisecond","ms"),L("S",Tc,Nc),L("SS",Tc,Oc),L("SSS",Tc,Pc),L("SSSS",Wc),O(["S","SS","SSS","SSSS"],function(a,b){b[hd]=p(1e3*("0."+a))});var Hd=B("Milliseconds",!1);G("z",0,0,"zoneAbbr"),G("zz",0,0,"zoneName");var Id=n.prototype;Id.add=wd,Id.calendar=_a,Id.clone=ab,Id.diff=gb,Id.endOf=sb,Id.format=kb,Id.from=lb,Id.fromNow=mb,Id.to=nb,Id.toNow=ob,Id.get=E,Id.invalidAt=zb,Id.isAfter=bb,Id.isBefore=cb,Id.isBetween=db,Id.isSame=eb,Id.isValid=xb,Id.lang=yd,Id.locale=pb,Id.localeData=qb,Id.max=sd,Id.min=rd,Id.parsingFlags=yb,Id.set=E,Id.startOf=rb,Id.subtract=xd,Id.toArray=wb,Id.toDate=vb,Id.toISOString=jb,Id.toJSON=jb,Id.toString=ib,Id.unix=ub,Id.valueOf=tb,Id.year=pd,Id.isLeapYear=ga,Id.weekYear=Cb,Id.isoWeekYear=Db,Id.quarter=Id.quarters=Gb,Id.month=W,Id.daysInMonth=X,Id.week=Id.weeks=la,Id.isoWeek=Id.isoWeeks=ma,Id.weeksInYear=Fb,Id.isoWeeksInYear=Eb,Id.date=zd,Id.day=Id.days=Mb,Id.weekday=Nb,Id.isoWeekday=Ob,Id.dayOfYear=oa,Id.hour=Id.hours=Ed,Id.minute=Id.minutes=Fd,Id.second=Id.seconds=Gd,Id.millisecond=Id.milliseconds=Hd,Id.utcOffset=Ka,Id.utc=Ma,Id.local=Na,Id.parseZone=Oa,Id.hasAlignedHourOffset=Pa,Id.isDST=Qa,Id.isDSTShifted=Ra,Id.isLocal=Sa,Id.isUtcOffset=Ta,Id.isUtc=Ua,Id.isUTC=Ua,Id.zoneAbbr=Ub,Id.zoneName=Vb,Id.dates=$("dates accessor is deprecated. Use date instead.",zd),Id.months=$("months accessor is deprecated. Use month instead",W),Id.years=$("years accessor is deprecated. Use year instead",pd),Id.zone=$("moment().zone is deprecated, use moment().utcOffset instead. https://github.com/moment/moment/issues/1779",La);var Jd=Id,Kd={sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"},Ld={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY LT",LLLL:"dddd, MMMM D, YYYY LT"},Md="Invalid date",Nd="%d",Od=/\d{1,2}/,Pd={future:"in %s",past:"%s ago",s:"a few seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"},Qd=r.prototype;Qd._calendar=Kd,Qd.calendar=Yb,Qd._longDateFormat=Ld,Qd.longDateFormat=Zb,Qd._invalidDate=Md,Qd.invalidDate=$b,Qd._ordinal=Nd,Qd.ordinal=_b,Qd._ordinalParse=Od,Qd.preparse=ac,Qd.postformat=ac,Qd._relativeTime=Pd,Qd.relativeTime=bc,Qd.pastFuture=cc,Qd.set=dc,Qd.months=S,Qd._months=id,Qd.monthsShort=T,Qd._monthsShort=jd,Qd.monthsParse=U,Qd.week=ia,Qd._week=qd,Qd.firstDayOfYear=ka,Qd.firstDayOfWeek=ja,Qd.weekdays=Ib,Qd._weekdays=Ad,Qd.weekdaysMin=Kb,Qd._weekdaysMin=Cd,Qd.weekdaysShort=Jb,Qd._weekdaysShort=Bd,Qd.weekdaysParse=Lb,Qd.isPM=Rb,Qd._meridiemParse=Dd,Qd.meridiem=Sb,v("en",{ordinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(a){var b=a%10,c=1===p(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th";return a+c}}),a.lang=$("moment.lang is deprecated. Use moment.locale instead.",v),a.langData=$("moment.langData is deprecated. Use moment.localeData instead.",x);var Rd=Math.abs,Sd=uc("ms"),Td=uc("s"),Ud=uc("m"),Vd=uc("h"),Wd=uc("d"),Xd=uc("w"),Yd=uc("M"),Zd=uc("y"),$d=wc("milliseconds"),_d=wc("seconds"),ae=wc("minutes"),be=wc("hours"),ce=wc("days"),de=wc("months"),ee=wc("years"),fe=Math.round,ge={s:45,m:45,h:22,d:26,M:11},he=Math.abs,ie=Ea.prototype;ie.abs=lc,ie.add=nc,ie.subtract=oc,ie.as=sc,ie.asMilliseconds=Sd,ie.asSeconds=Td,ie.asMinutes=Ud,ie.asHours=Vd,ie.asDays=Wd,ie.asWeeks=Xd,ie.asMonths=Yd,ie.asYears=Zd,ie.valueOf=tc,ie._bubble=pc,ie.get=vc,ie.milliseconds=$d,ie.seconds=_d,ie.minutes=ae,ie.hours=be,ie.days=ce,ie.weeks=xc,ie.months=de,ie.years=ee,ie.humanize=Bc,ie.toISOString=Cc,ie.toString=Cc,ie.toJSON=Cc,ie.locale=pb,ie.localeData=qb,ie.toIsoString=$("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",Cc),ie.lang=yd,G("X",0,0,"unix"),G("x",0,0,"valueOf"),L("x",Xc),L("X",Zc),O("X",function(a,b,c){c._d=new Date(1e3*parseFloat(a,10))}),O("x",function(a,b,c){c._d=new Date(p(a))}),a.version="2.10.3",b(Aa),a.fn=Jd,a.min=Ca,a.max=Da,a.utc=h,a.unix=Wb,a.months=gc,a.isDate=d,a.locale=v,a.invalid=l,a.duration=Va,a.isMoment=o,a.weekdays=ic,a.parseZone=Xb,a.localeData=x,a.isDuration=Fa,a.monthsShort=hc,a.weekdaysMin=kc,a.defineLocale=w,a.weekdaysShort=jc,a.normalizeUnits=z,a.relativeTimeThreshold=Ac;var je=a;return je}),function(){for(var a,b=function(){},c=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeline","timelineEnd","timeStamp","trace","warn"],d=c.length,e=window.console=window.console||{};d--;)a=c[d],e[a]||(e[a]=b)}(),function(){"use strict";function a(){$.ajax({url:"../data/longtest.json",dataType:"json",type:"GET"}).done(function(a){console.log(a),b(a,"#chart","kWh"),u=a,$(".header-toggle span:first-child").text(a.name+" "+a.surname),$.each(a.addressList,function(b,c){$(".js-addressList").append('<option value="'+c.eic+'"'+(a.address==c.address?"selected":"")+">"+c.address+", eic: "+c.eic+"</option>")}),$.each(a.fuseValues,function(a,b){$(".js-fuseList").append('<option value="'+b+'">'+b+"</option>")})}).fail(function(a,b){console.log("Ajax Error Triggered : "+b),console.log("Error: "+a)})}function b(a,b,c){var j=a.graphReadings,k=j.length,l=!1,m=!1,n=!1,p=!1,q=!0,s=!0,t=!0;if(v=c3.generate({bindto:b,padding:{bottom:0},data:{x:"x",columns:[],type:"area-spline"},axis:{x:{type:"timeseries",tick:{fit:!1,format:function(a){return w(a)},centered:!0,localtime:!0}}},grid:{y:{show:!0}},legend:{show:!1},point:{show:!1},size:{height:500},color:{pattern:["#fff"]},zoom:{enabled:!0,onzoom:function(a){if(!q){var b=o(a[1],a[0]);console.log("onzoom domaindiff: "+b),d(b),20>=b?(l||t||("A1"==c||"A3"==c?g(v,k,j,c,a[0],a[1]):"kWh"==c&&e(v,k,j,a[0],a[1])),l=!0,m=!1,t=!1):(m||t||("A1"==c||"A3"==c?v.unload({ids:["A1f","A3f"]}):"kWh"==c&&v.unload({ids:["kWhf"]})),m=!0,l=!1,t=!1)}q=!1}},subchart:{show:!0,onbrush:function(a){var b=o(a[1],a[0]);console.log("onbrush domaindiff: "+b),d(b),20>=b?(s||setTimeout(function(){"A1"==c||"A3"==c?g(v,k,j,c,a[0],a[1]):"kWh"==c&&e(v,k,j,a[0],a[1])},500),p=!1,s=!1):(p||s||("A1"==c||"A3"==c?v.unload({ids:["A1f","A3f"]}):"kWh"==c&&v.unload({ids:["kWhf"]})),p=!0,n=!1,s=!1)}}}),k>0)switch(c){case"kWh":f(v,k,j);break;case"A1":h(v,k,j,c),i(v,k,a);break;case"A3":h(v,k,j,c),i(v,k,a)}else v.load({columns:[0,0]});r($("#loader"))}function c(a){"big"==a?w=d3.time.format("%B"):"middle"==a?w=d3.time.format("%d.%m"):"small"==a&&(w=d3.time.format("%H:%M %d.%m"))}function d(a){c(a>150?"big":150>=a&&a>20?"middle":"small")}function e(a,b,d,e,f){console.log("generateAllKWHDataChart");var g=["x"],h=["kWhf"];c("small");for(var i=0;b>i;i++)moment.utc(d[i].time)>=moment.utc(e)&&moment.utc(d[i].time)<=moment.utc(f)&&(g.push(moment.utc(d[i].time)),h.push(d[i].kWh));console.log(g),console.log(h),a.load({columns:[g,h]})}function f(a,b,d){console.log("generateSumKWHDataChart");var e=["x"],f=["kWh"],g=[],h=d[0].time.slice(0,10);c("middle");for(var i=0;b>i;i++){if(d[i].time.slice(0,10)!=h){for(var j=0,k=g.length,l=0;k>l;l++){var m=parseFloat(g[l])?g[l]:0;j+=m}f.push(j),e.push(d[i-1].time.slice(0,10)),g.splice(0,g.length),h=d[i].time.slice(0,10)}g.push(d[i].kWh)}console.log(e),console.log(f),a.load({columns:[e,f]})}function g(a,b,d,e,f,g){console.log("generateAllFuseDataChart");var h=["x"],i=["A1f"];c("small");for(var j=0;b>j;j++)if(moment.utc(d[j].time)>=moment.utc(f)&&moment.utc(d[j].time)<=moment.utc(g)){var k;"A1"==e?k=d[j].A1:"A3"==e&&(k=d[j].A3),h.push(moment.utc(d[j].time)),i.push(k)}console.log(h),console.log(i),a.load({columns:[h,i]})}function h(a,b,d,e){console.log("generateAvgFuseDataChart");var f=["x"],g=[e],h=[],i=d[0].time.slice(0,10);c("middle");for(var j=0;b>j;j++){if(d[j].time.slice(0,10)!=i){for(var k=0,l=h.length,m=0;l>m;m++){var n=parseFloat(h[m])?h[m]:0;k+=n}var o=k/l;g.push(o),f.push(d[j-1].time.slice(0,10)),h.splice(0,h.length),i=d[j].time.slice(0,10)}"A1"==e?h.push(d[j].A1):"A3"==e&&h.push(d[j].A3)}console.log(f),console.log(g),a.load({columns:[f,g]})}function i(a,b,c){c.recommendedFuseSize==c.calculatedMinFuseSize?a.ygrids.add([{value:c.recommendedFuseSize,text:"YAY! Atta boy "+c.recommendedFuseSize+"A"}]):a.ygrids.add([{value:c.recommendedFuseSize,text:"Soovitame peakaitsme suuruseks: "+c.recommendedFuseSize+"A"},{value:c.calculatedMinFuseSize,text:"Vajalik peakaitsme suurus: "+c.calculatedMinFuseSize+"A"}]),j(a,0,16,"regionX");var d=Math.max(c.recommendedFuseSize,c.calculatedMinFuseSize);a.axis.range({max:{y:d},min:{y:2}}),k(a,l())}function j(a,b,c,d){a.regions.add([{axis:"y",start:b,end:c,"class":d}])}function k(a,b){var c=new Date,d=o(c,b),e=new Date;new Date(e.setDate(c.getDate()-d)),a.zoom([e,c])}function l(){var a=new Date;return new Date(a.getFullYear(),a.getMonth()-1,1)}function m(){var a=new Date;return new Date(a.setDate(a.getDate()-7))}function n(){var a=new Date;return new Date(a.setDate(a.getDate()-1))}function o(a,b){return Math.floor((Date.parse(a)-Date.parse(b))/864e5)}function p(a){return Math.max.apply(null,a)}function q(a){a.show()}function r(a){a.fadeOut("slow")}function s(a,b){var c;$.each(a,function(a,d){$(d).data("unit")==b&&(c=$(d))}),c.siblings().removeClass("active"),c.addClass("active"),c.siblings().find(".glyphicon").removeClass("glyphicon-ok-sign").addClass("glyphicon-one-fine-empty-dot"),c.find(".glyphicon").removeClass("glyphicon-one-fine-empty-dot").addClass("glyphicon-ok-sign")}if(navigator.userAgent.match(/IEMobile\/10\.0/)){var t=document.createElement("style");t.appendChild(document.createTextNode("@-ms-viewport{width:auto!important}")),document.querySelector("head").appendChild(t)}$(function(){$('[data-toggle="tooltip"]').tooltip(),a()});var u,v;$(".js-showChart").on("click",function(a){a.preventDefault();var c=$('input:radio[name="amp"]:checked').val(),d=$(".js-fuseList").val();b(u,"#chart",c);var e=[d,u.recommendedFuseSize,u.calculatedMinFuseSize],f=p(e);v.axis.range({max:{y:f},min:{y:2}}),v.ygrids.add([{value:d,text:"Kasutatav peakaitsme suurus: "+d+"A"}]),s($(".js-changeUnit"),c)}),$(".js-changeUnit").on("click",function(){q($("#loader"));var a=$(this),c=a.data("unit");$(".js-fuseList").val();b(u,"#chart",c),s(a,c)});var w;d3.select(".js-week").on("click",function(){c("small"),k(v,m())}),d3.select(".js-day").on("click",function(){c("small"),k(v,n())}),d3.select(".js-unZoom").on("click",function(){c("big"),v.unzoom()})}();