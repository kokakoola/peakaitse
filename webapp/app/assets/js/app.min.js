...
y("date","D"),L("D",Sc),L("DD",Sc,Oc),L("Do",function(a,b){return a?b._ordinalParse:b._ordinalParseLenient}),O(["D","DD"],dd),O("Do",function(a,b){b[dd]=p(a.match(Sc)[0],10)});var zd=B("Date",!0);G("d",0,"do","day"),G("dd",0,0,function(a){return this.localeData().weekdaysMin(this,a)}),G("ddd",0,0,function(a){return this.localeData().weekdaysShort(this,a)}),G("dddd",0,0,function(a){return this.localeData().weekdays(this,a)}),G("e",0,0,"weekday"),G("E",0,0,"isoWeekday"),y("day","d"),y("weekday","e"),y("isoWeekday","E"),L("d",Sc),L("e",Sc),L("E",Sc),L("dd",$c),L("ddd",$c),L("dddd",$c),P(["dd","ddd","dddd"],function(a,b,c){var d=c._locale.weekdaysParse(a);null!=d?b.d=d:j(c).invalidWeekday=a}),P(["d","e","E"],function(a,b,c,d){b[d]=p(a)});var Ad="Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),Bd="Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),Cd="Su_Mo_Tu_We_Th_Fr_Sa".split("_");G("H",["HH",2],0,"hour"),G("h",["hh",2],0,function(){return this.hours()%12||12}),Pb("a",!0),Pb("A",!1),y("hour","h"),L("a",Qb),L("A",Qb),L("H",Sc),L("h",Sc),L("HH",Sc,Oc),L("hh",Sc,Oc),O(["H","HH"],ed),O(["a","A"],function(a,b,c){c._isPm=c._locale.isPM(a),c._meridiem=a}),O(["h","hh"],function(a,b,c){b[ed]=p(a),j(c).bigHour=!0});var Dd=/[ap]\.?m?\.?/i,Ed=B("Hours",!0);G("m",["mm",2],0,"minute"),y("minute","m"),L("m",Sc),L("mm",Sc,Oc),O(["m","mm"],fd);var Fd=B("Minutes",!1);G("s",["ss",2],0,"second"),y("second","s"),L("s",Sc),L("ss",Sc,Oc),O(["s","ss"],gd);var Gd=B("Seconds",!1);G("S",0,0,function(){return~~(this.millisecond()/100)}),G(0,["SS",2],0,function(){return~~(this.millisecond()/10)}),Tb("SSS"),Tb("SSSS"),y("millisecond","ms"),L("S",Tc,Nc),L("SS",Tc,Oc),L("SSS",Tc,Pc),L("SSSS",Wc),O(["S","SS","SSS","SSSS"],function(a,b){b[hd]=p(1e3*("0."+a))});var Hd=B("Milliseconds",!1);G("z",0,0,"zoneAbbr"),G("zz",0,0,"zoneName");var Id=n.prototype;Id.add=wd,Id.calendar=_a,Id.clone=ab,Id.diff=gb,Id.endOf=sb,Id.format=kb,Id.from=lb,Id.fromNow=mb,Id.to=nb,Id.toNow=ob,Id.get=E,Id.invalidAt=zb,Id.isAfter=bb,Id.isBefore=cb,Id.isBetween=db,Id.isSame=eb,Id.isValid=xb,Id.lang=yd,Id.locale=pb,Id.localeData=qb,Id.max=sd,Id.min=rd,Id.parsingFlags=yb,Id.set=E,Id.startOf=rb,Id.subtract=xd,Id.toArray=wb,Id.toDate=vb,Id.toISOString=jb,Id.toJSON=jb,Id.toString=ib,Id.unix=ub,Id.valueOf=tb,Id.year=pd,Id.isLeapYear=ga,Id.weekYear=Cb,Id.isoWeekYear=Db,Id.quarter=Id.quarters=Gb,Id.month=W,Id.daysInMonth=X,Id.week=Id.weeks=la,Id.isoWeek=Id.isoWeeks=ma,Id.weeksInYear=Fb,Id.isoWeeksInYear=Eb,Id.date=zd,Id.day=Id.days=Mb,Id.weekday=Nb,Id.isoWeekday=Ob,Id.dayOfYear=oa,Id.hour=Id.hours=Ed,Id.minute=Id.minutes=Fd,Id.second=Id.seconds=Gd,Id.millisecond=Id.milliseconds=Hd,Id.utcOffset=Ka,Id.utc=Ma,Id.local=Na,Id.parseZone=Oa,Id.hasAlignedHourOffset=Pa,Id.isDST=Qa,Id.isDSTShifted=Ra,Id.isLocal=Sa,Id.isUtcOffset=Ta,Id.isUtc=Ua,Id.isUTC=Ua,Id.zoneAbbr=Ub,Id.zoneName=Vb,Id.dates=$("dates accessor is deprecated. Use date instead.",zd),Id.months=$("months accessor is deprecated. Use month instead",W),Id.years=$("years accessor is deprecated. Use year instead",pd),Id.zone=$("moment().zone is deprecated, use moment().utcOffset instead. https://github.com/moment/moment/issues/1779",La);var Jd=Id,Kd={sameDay:"[Today at] LT",nextDay:"[Tomorrow at] LT",nextWeek:"dddd [at] LT",lastDay:"[Yesterday at] LT",lastWeek:"[Last] dddd [at] LT",sameElse:"L"},Ld={LTS:"h:mm:ss A",LT:"h:mm A",L:"MM/DD/YYYY",LL:"MMMM D, YYYY",LLL:"MMMM D, YYYY LT",LLLL:"dddd, MMMM D, YYYY LT"},Md="Invalid date",Nd="%d",Od=/\d{1,2}/,Pd={future:"in %s",past:"%s ago",s:"a few seconds",m:"a minute",mm:"%d minutes",h:"an hour",hh:"%d hours",d:"a day",dd:"%d days",M:"a month",MM:"%d months",y:"a year",yy:"%d years"},Qd=r.prototype;Qd._calendar=Kd,Qd.calendar=Yb,Qd._longDateFormat=Ld,Qd.longDateFormat=Zb,Qd._invalidDate=Md,Qd.invalidDate=$b,Qd._ordinal=Nd,Qd.ordinal=_b,Qd._ordinalParse=Od,Qd.preparse=ac,Qd.postformat=ac,Qd._relativeTime=Pd,Qd.relativeTime=bc,Qd.pastFuture=cc,Qd.set=dc,Qd.months=S,Qd._months=id,Qd.monthsShort=T,Qd._monthsShort=jd,Qd.monthsParse=U,Qd.week=ia,Qd._week=qd,Qd.firstDayOfYear=ka,Qd.firstDayOfWeek=ja,Qd.weekdays=Ib,Qd._weekdays=Ad,Qd.weekdaysMin=Kb,Qd._weekdaysMin=Cd,Qd.weekdaysShort=Jb,Qd._weekdaysShort=Bd,Qd.weekdaysParse=Lb,Qd.isPM=Rb,Qd._meridiemParse=Dd,Qd.meridiem=Sb,v("en",{ordinalParse:/\d{1,2}(th|st|nd|rd)/,ordinal:function(a){var b=a%10,c=1===p(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th";return a+c}}),a.lang=$("moment.lang is deprecated. Use moment.locale instead.",v),a.langData=$("moment.langData is deprecated. Use moment.localeData instead.",x);var Rd=Math.abs,Sd=uc("ms"),Td=uc("s"),Ud=uc("m"),Vd=uc("h"),Wd=uc("d"),Xd=uc("w"),Yd=uc("M"),Zd=uc("y"),$d=wc("milliseconds"),_d=wc("seconds"),ae=wc("minutes"),be=wc("hours"),ce=wc("days"),de=wc("months"),ee=wc("years"),fe=Math.round,ge={s:45,m:45,h:22,d:26,M:11},he=Math.abs,ie=Ea.prototype;ie.abs=lc,ie.add=nc,ie.subtract=oc,ie.as=sc,ie.asMilliseconds=Sd,ie.asSeconds=Td,ie.asMinutes=Ud,ie.asHours=Vd,ie.asDays=Wd,ie.asWeeks=Xd,ie.asMonths=Yd,ie.asYears=Zd,ie.valueOf=tc,ie._bubble=pc,ie.get=vc,ie.milliseconds=$d,ie.seconds=_d,ie.minutes=ae,ie.hours=be,ie.days=ce,ie.weeks=xc,ie.months=de,ie.years=ee,ie.humanize=Bc,ie.toISOString=Cc,ie.toString=Cc,ie.toJSON=Cc,ie.locale=pb,ie.localeData=qb,ie.toIsoString=$("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)",Cc),ie.lang=yd,G("X",0,0,"unix"),G("x",0,0,"valueOf"),L("x",Xc),L("X",Zc),O("X",function(a,b,c){c._d=new Date(1e3*parseFloat(a,10))}),O("x",function(a,b,c){c._d=new Date(p(a))}),a.version="2.10.3",b(Aa),a.fn=Jd,a.min=Ca,a.max=Da,a.utc=h,a.unix=Wb,a.months=gc,a.isDate=d,a.locale=v,a.invalid=l,a.duration=Va,a.isMoment=o,a.weekdays=ic,a.parseZone=Xb,a.localeData=x,a.isDuration=Fa,a.monthsShort=hc,a.weekdaysMin=kc,a.defineLocale=w,a.weekdaysShort=jc,a.normalizeUnits=z,a.relativeTimeThreshold=Ac;var je=a;return je}),function(){for(var a,b=function(){},c=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeline","timelineEnd","timeStamp","trace","warn"],d=c.length,e=window.console=window.console||{};d--;)a=c[d],e[a]||(e[a]=b)}(),function(){"use strict";function a(a){"big"==a?r=d3.time.format("%B"):"middle"==a?r=d3.time.format("%d.%m"):"small"==a&&(r=d3.time.format("%H:%M %d.%m"))}function b(b,c,d,e,f){console.log("generateAllKWHDataChart"),a("small");for(var g=0;c>g;g++){var h=d[g].kWh;e.push(moment.utc(d[g].time)),f.push(h)}console.log(e),console.log(f),b.load({columns:[e,f]})}function c(b,c,d,e,f){console.log("generateSumKWHDataChart"),a("middle");for(var g=[],h=d[0].time.slice(0,10),i=0;c>i;i++){if(d[i].time.slice(0,10)!=h){for(var j=0,k=g.length,l=0;k>l;l++){var m=parseFloat(g[l])?g[l]:0;j+=m}f.push(j),e.push(d[i-1].time.slice(0,10)),g.splice(0,g.length),h=d[i].time.slice(0,10)}g.push(d[i].kWh)}console.log(e),console.log(f),b.load({columns:[e,f]})}function d(b,c,d,e,f,g){console.log("generateAllFuseDataChart"),a("small");for(var h=0;c>h;h++){var i;"A1"==g?i=d[h].A1:"A3"==g&&(i=d[h].A3),e.push(moment.utc(d[h].time)),f.push(i)}console.log(e),console.log(f),b.load({columns:[e,f]})}function e(b,c,d,e,f,g){console.log("generateAvgFuseDataChart"),a("middle");for(var h=[],i=d[0].time.slice(0,10),j=0;c>j;j++){if(d[j].time.slice(0,10)!=i){for(var k=0,l=h.length,m=0;l>m;m++){var n=parseFloat(h[m])?h[m]:0;k+=n}var o=k/l;f.push(o),e.push(d[j-1].time.slice(0,10)),h.splice(0,h.length),i=d[j].time.slice(0,10)}"A1"==g?h.push(d[j].A1):"A3"==g&&h.push(d[j].A3)}console.log(e),console.log(f),b.load({columns:[e,f]})}function f(a,b,c,d,e){c.recommendedFuseSize==c.calculatedMinFuseSize?a.ygrids.add([{value:c.recommendedFuseSize,text:"YAY! Atta boy "+c.recommendedFuseSize+"A"}]):a.ygrids.add([{value:c.recommendedFuseSize,text:"Soovituslik "+c.recommendedFuseSize+"A"},{value:c.calculatedMinFuseSize,text:"Vajalik "+c.calculatedMinFuseSize+"A"}]),g(a),e.shift();var f,j=Math.max(c.recommendedFuseSize,c.calculatedMinFuseSize),k=m(e);f=j>k?j:k,a.axis.range({max:{y:f},min:{y:2}}),h(a,i())}function g(a){a.regions.add([{axis:"y",start:0,end:16,"class":"regionX"}])}function h(a,b){var c=new Date,d=l(c,b),e=new Date;new Date(e.setDate(c.getDate()-d)),a.zoom([e,c])}function i(){var a=new Date;return new Date(a.getFullYear(),a.getMonth()-1,1)}function j(){var a=new Date;return new Date(a.setDate(a.getDate()-7))}function k(){var a=new Date;return new Date(a.setDate(a.getDate()-1))}function l(a,b){return Math.floor((Date.parse(a)-Date.parse(b))/864e5)}function m(a){return Math.max.apply(null,a)}function n(a){a.show()}function o(a){a.fadeOut("slow")}if(navigator.userAgent.match(/IEMobile\/10\.0/)){var p=document.createElement("style");p.appendChild(document.createTextNode("@-ms-viewport{width:auto!important}")),document.querySelector("head").appendChild(p)}$(function(){$('[data-toggle="tooltip"]').tooltip(),t("#chart","1F")});var q,r,s='<linearGradient id="blueGradient" x1="100%" y1="0%" x2="100%" y2="100%" gradientUnits="objectBoundingBox">  <stop offset="4%" style="stop-color:rgb(241, 251, 255); stop-opacity:0"></stop>  <stop offset="46%" style="stop-color:rgb(0, 174, 230); stop-opacity:1"></stop>  <stop offset="98%" style="stop-color:rgb(230, 249, 255); stop-opacity:0"></stop></linearGradient>',t=function(g,h){function i(){$.ajax({url:"https://xenon.netgroupdigital.com:8443/mainfuse/data",dataType:"json",type:"POST"}).done(function(a){console.log(a),j(a)}).fail(function(a,b){console.log("Ajax Error Triggered : "+b),console.log("Error: "+a)})}function j(i){var j=i.graphReadings,k=j.length,m=!1,n=!1,p=!1,t=!1,u=!0,v=!0,w=!0;if(q=c3.generate({bindto:g,padding:{bottom:20},data:{x:"x",columns:[],type:"area-spline"},axis:{x:{type:"timeseries",tick:{fit:!1,format:function(a){return r(a)},centered:!0,localtime:!0}}},grid:{y:{show:!0}},legend:{show:!1},point:{show:!1},size:{height:600},oninit:function(){this.svg[0][0].getElementsByTagName("defs")[0].innerHTML+=s},zoom:{enabled:!0,onzoom:function(f){if(console.log("-----------"),console.log("is zooming"),console.log("domain: "+f),!u){var g=l(f[1],f[0]);if(console.log("onzoom domaindiff: "+g),a(g>150?"big":150>=g&&g>35?"middle":"small"),35>=g){if(console.log("under 35"),console.log("isZoomed: "+m),console.log("isFirstZoom: "+w),!m&&!w){var i=["x"],o=[h];"1F"==h||"3F"==h?d(q,k,j,i,o,"A1"):"kwh"==h&&b(q,k,j,i,o)}m=!0,n=!1,w=!1}else{if(console.log("over 35"),!n&&!w){var i=["x"],o=[h];"1F"==h||"3F"==h?e(q,k,j,i,o,"A1"):"kwh"==h&&c(q,k,j,i,o)}n=!0,m=!1,w=!1}}u=!1}},subchart:{show:!0,onbrush:function(f){console.log("-----------"),console.log("onbrush");var g=l(f[1],f[0]);if(console.log("onbrush domaindiff: "+g),a(g>150?"big":150>=g&&g>35?"middle":"small"),35>=g){if(console.log(p),!p&&!v){var i=["x"],m=[h];"1F"==h||"3F"==h?d(q,k,j,i,m,"A1"):"kwh"==h&&b(q,k,j,i,m)}p=!0,t=!1,v=!1}else{if(!t&&!v){var i=["x"],m=[h];"1F"==h||"3F"==h?e(q,k,j,i,m,"A1"):"kwh"==h&&c(q,k,j,i,m)}t=!0,p=!1,v=!1}}}}),k>0)switch(h){case"kwh":var x=["x"],y=[h];c(q,k,j,x,y);break;case"1F":var x=["x"],y=[h];e(q,k,j,x,y,"A1"),f(q,k,i,x,y);break;case"3F":var x=["x"],y=[h];e(q,k,j,x,y,"A3"),f(q,k,i,x,y)}else q.load({columns:[0,0]});o($("#loader"))}i()};$(".js-changeUnit").on("click",function(){n($("#loader"));var a=$(this);a.siblings().removeClass("active"),a.addClass("active");var b=a.data("unit");t("#chart",b)}),d3.select(".js-week").on("click",function(){a("small"),h(q,j())}),d3.select(".js-day").on("click",function(){a("small"),h(q,k())}),d3.select(".js-unZoom").on("click",function(){a("big"),q.unzoom()})}();